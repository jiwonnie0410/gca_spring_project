...
<body>
						...
						<c:when test="${m_id == dto.m_id}">
							<div class="form-group" align="center">
								<div align="center">
									...
									<h4 align="center">
										<input name="ad_title" id="ad_title" value="${dto.ad_title}"
											placeholder="제목을 입력해주세요"
											style="border-color: #FE9191; border: none;align-content: center; " >
										</h1>
								</div>
							</div>
						</c:when>
					...
					<div class="form-group">
						<div>
							...
							<%-- <img style="padding-bottom: 5px;" width="65px" height="65px"
								src="${pageContext.request.contextPath }/resources/images/bok/place.png"> --%>
					...
					<c:choose>
						<c:when test="${m_id == dto.m_id}">
							<div class="form-group">
								<div>
									<label
										style="background-color: #FE9191; color: white; border-radius: 10px; width: 100px; text-align: center;">동호회
										소개</label>&nbsp;&nbsp;
									<textarea name="ad_content" cols="40" id="ad_content"
										placeholder="내용을 입력해주세요"
										style="border-color: #FE9191; border: none;">${dto.ad_content}</textarea>
								</div>
							</div>
							<div class="form-group" align="center">
								<!-- 게시물번호를 hidden으로 처리 -->
								...
								<button type="button" class="btn" id="btnUpdete"
									style="background-color: #FE9191; color: white;">수정</button>
								<button type="button" class="btn " id="btnDelete"
									style="background-color: #FE9191; color: white;">삭제</button>
	...
	<!-- 게시물 상세보기 영역 -->
		<table>
			<tr>
				<td>
					<textarea rows="3" cols="32" id="adr_content"placeholder="댓글을 작성해주세요"></textarea>
				</td>
				<td>
					<button type="button" class="btn " id="btnReply"
						style="background-color: #FE9191; color: white;">댓글<br> 작성</button> 
					<br> <!-- 비밀댓글 체크박스 --> 
					<input type="checkbox" id="adr_hidden" style="border-color: #FE9191;">비밀
				</td>
			</tr>
		</table>
	<!-- 댓글 목록 영역 -->
