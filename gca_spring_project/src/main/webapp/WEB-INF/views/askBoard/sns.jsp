...
<link rel="stylesheet"
	href="../resources/css/icomoon.css">
<link rel="stylesheet"
...
<body style="overflow: hidden; background-color: #f0f0f0;">
	<div class="sns_wrap">
		...
		<ul class="ftco-social text-center">
			<li><a class="ftco-animate"
				href="javascript:toSNS('facebook','공유제목!','http://http://단축URL')"
				title="페이스북으로 가져가기"><span class="icon-facebook"></span></a></li>
			<li><a class="ftco-animate"
				href="javascript:toSNS('twitter','공유제목!','http://http://단축URL')"
				title="트위터로 가져가기"><span class="icon-twitter"></span></a></li>
			<li><a class="ftco-animate"
				href="javascript:toSNS('line','공유제목!','http://http://단축URL')"
				title="라인으로 가져가기"><i class="fab fa-line"></i></a></li>
			<li><a class="ftco-animate" href="javascript:sendKakaoTalk();"
				title="카카오톡으로 가져가기"><i class="fab fa-kickstarter"></i></a></li>
			<li><a
				href="javascript:toSNS('google','공유제목!','http://http://단축URL')"
				title="구글플러스로 가져가기"></a></li>
		</ul>
		<ul>
			<li><input type="text" value="http://도메인"><a
				href="javascript:copy_clip('http://도메인')"><i
...
<script
	src="../resources/js/jquery-migrate-3.0.1.min.js"></script>
...
<script
	src="../resources/js/jquery.animateNumber.min.js"></script>
