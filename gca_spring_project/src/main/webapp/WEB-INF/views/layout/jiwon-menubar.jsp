...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<nav class="navbar fixed-bottom" style="position:fixed;z-index:50;background-color:white;">
		<!-- 메뉴바에 들어가는 아이콘 5개 -->
		<!-- 프로필로 가기 + 쪽지 갯수 -->
		<span id="nav_profile">
			<i class="fas fa-user" onclick='location.href="${pageContext.request.contextPath }/member/member_view.do"'></i>
			<br><font size="2" style="position:absolute;bottom:2px">프로필</font>
