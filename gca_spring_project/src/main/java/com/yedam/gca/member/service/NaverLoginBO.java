...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "BJ76vTS9xilyC5p9YXrY";
	private final static String CLIENT_SECRET = "VIbOx5iXYy";
	private final static String REDIRECT_URI = "http://localhost/gca/login/naverCallback";
